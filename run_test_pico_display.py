...
Uses the unified md_sim backend (ulab_c if C extension is built, else ulab).
...
Run with: mpremote run run_test_pico_display.py
"""
import time
import gc
...
# Test configurations (matching run_test_all.py)
CONFIGS = [
    {"nx": 5, "ny": 5, "as": 10},
    {"nx": 8, "ny": 8, "as": 10},
    {"nx": 10, "ny": 10, "as": 10},
